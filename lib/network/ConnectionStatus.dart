...
///ConnectionStatus _connectionStatus = ConnectionStatus.getInstance;
///
/// Check ConnectionStatus
///bool onlineStatus = await _connectionStatus.checkConnection();
///
///On status change
/// _connectionStatus.connectionChange.listen((onlineStatus) {
///             Perform task
///             });
///
